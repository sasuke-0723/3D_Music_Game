...
[Serializable]
public class SaveManager : ISerializationCallbackReceiver
{
    ...
    {
        _instance = JsonUtility.FromJson<SaveManager>(GetJson());
    }
    ...
    private static string GetJson()
    {
        ...
        {
            _jsonText = StringEncryption.Decrypt(File.ReadAllText(filePath));
        }
        else
        {
            _jsonText = JsonUtility.ToJson(new SaveManager());
        }
    ...
    public void Save()
    {
        ...
        File.WriteAllText(GetSaveFilePath(), StringEncryption.Encrypt(_jsonText));
    }
